...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        for line in test_desc:
            if line.startswith("__label__Coherent "):
                desc = line[len("__label__Coherent "):]
                label = 1
            elif line.startswith("__label__Incoherent "):
                desc = line[len("__label__Incoherent "):]
                label = 0
            elif line.strip():
                print("<EMPTY?")
                print(line)
            ...
            if predLabel == "__label__Coherent":
                pred = 1
            elif predLabel == "__label__Incoherent":
                pred = 0
            else:
